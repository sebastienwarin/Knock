...
namespace Knock
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (args.Length >= 2 && IPAddress.TryParse(args[0], out address))
            {
            ...
            {
                Console.WriteLine("usage: knock.exe <IP> <port> [port] ...");
                Console.WriteLine("example: knock.exe 192.168.0.1 123 456 789");
            }
        }        
    }
}
